...
var NbPasswordAuthStrategyOptions = /** @class */ (function (_super) {
    ...
    function NbPasswordAuthStrategyOptions() {
        ...
        _this.login = {
            ...
            defaultErrors: ['Login/Email incorreto, por favor tente novamente.'],
        ...
        _this.register = {
            ...
            defaultErrors: ['Alguma coisa está errado, por favor tente novamente.'],
            defaultMessages: ['Cadastro feito com sucesso!.'],
        };
        _this.requestPass = {
            ...
            defaultErrors: ['Alguma coisa está errado, por favor tente novamente.'],
            defaultMessages: ['As instruções para recuperar sua senha foram enviadas para seu e-mail.'],
        };
        _this.resetPass = {
            endpoint: 'reset-pass',
            method: 'put',
            ...
            defaultErrors: ['Alguma coisa está errado, por favor tente novamente.'],
            defaultMessages: ['A sua senha foi atualizada com sucesso!.'],
        };
        _this.logout = {
            alwaysFail: false,
            endpoint: 'logout',
            ...
            defaultMessages: ['Logout feito com sucesso.'],
        };
        _this.refreshToken = {
...
var NbOAuth2AuthStrategy = /** @class */ (function (_super) {
    ...
    NbOAuth2AuthStrategy.prototype.refreshToken = function (token) {
        ...
        return this.http.post(url, this.buildRefreshRequestData(token))
            ...
            return rxjs.of(new NbAuthResult(false, res, _this.getOption('redirect.failure'), errors, []));
        }));
    };
